    ...
    return (
        <div className="flex flex-col min-h-screen bg-gradient-to-b from-indigo-50 via-purple-50 to-indigo-50">
            <div className="container mx-auto p-6 flex-grow">
                ...
                {/* Blog Content */}
                {isEditing ? (
                    <form onSubmit={handleEditSubmit} className="space-y-6 bg-white rounded-lg shadow-lg p-8">
                        <div>
                            ...
                            <input
                                ...
                                className="p-3 w-full border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-yellow-500"
                            />
